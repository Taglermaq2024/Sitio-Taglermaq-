...
// TODO: Mejora la búsqueda principal de máquinas
...
function get_video_filter_data($paged = 1, $posts_per_page = 6) { // Valores por defecto para la carga inicial
    global $wp_query;
...
function mi_sitio_enqueue_scripts() {
    ...
    wp_localize_script( 'mi-sitio-ajax-load', 'miSitioAjax', array(
        ...
        'posts_per_page' => 8, // Número de videos a cargar por cada petición AJAX
...
function mi_sitio_load_more_videos() {
    ...
    if ( $ajax_query->have_posts() ) :
        while ( $ajax_query->have_posts() ) : $ajax_query->the_post();
            ...
            ?>" data-vbtype="video" data-autoplay="true" data-aos="fade-up">
