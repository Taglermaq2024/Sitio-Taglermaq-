            ...
            while ($comics_query->have_posts()) :
               ...
               <article id="post-<?php the_ID(); ?>" <?php post_class('my-animation box-comics'); ?>>
                  <div class="content-img">
                     ...
                     <!-- Comprueba si el cómic tiene una imagen destacada -->
                     <?php
                     if (has_post_thumbnail()) :
                        // Muestra la imagen destacada en tamaño 'full'
                  ...
                  <section class="content-titles-comics">
                     <div class="margenes-titles">
                        ...
                        <div class="wrapper-button">
                           <?php if (get_field('version_espanol')): ?>
                              <a class="no-preload" href="<?php bloginfo('template_url'); ?>/historietas/<?php echo esc_html(get_field('version_espanol')); ?>.pdf" target="_blank">
                                 <button class="pdf-espanol">Español</button>
                              </a>
                           <?php endif; ?>

                           <?php if (get_field('version_ingles')): ?>
                              <a class="no-preload" href="<?php bloginfo('template_url'); ?>/historietas/<?php echo esc_html(get_field('version_ingles')); ?>.pdf" target="_blank">
