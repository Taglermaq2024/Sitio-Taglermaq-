...
.fondo__organigram .box__organigram2 ul li  .card-a .front, .fondo__organigram .box__organigram2 ul li .card-a .back {
  position: absolute;
  height: 100%;
  width: 100%;
  background: white;
...
.fondo__organigram .box__organigram2 ul li .card-1 .front, .fondo__organigram .box__organigram2 ul li .card-2 .front, .fondo__organigram .box__organigram2 ul li .card-3 .front{
...
@media(max-width: 991px) {
    ...
    .fondo__organigram .box__deptos2, .fondo__organigram .box__organigram2 {
    width: 100%;
    }
    .fondo__organigram .box__organigram2 {
     display:none;
...
<section class="mision-vision"></section><section class="wrapper-mision2">
...
</section><section class="wrapper-mision3"><img class="image-hexagon1" src="https://www.taglermaq.cl/wp-content/uploads/2021/08/image-hexagon1.svg" />
...
</section><section class="nuestros__valores">
...
<img class="img__valores" src="<?php bloginfo('template_url'); ?>/img-temporal/compromiso-con-clientes-2023-02.jpg" alt="Compromiso con nuestros clientes" />
<div class="content__textos">
