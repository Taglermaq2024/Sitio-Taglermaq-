...
<div class="wrapper-mi-swiper">
    ...
    <div class="swiper-carrusel-principal">
        <div class="swiper-wrapper">
            ...
            <!-- Banner Gunther Tumbler -->
            <div class="swiper-slide" style="overflow: hidden">
                <div class="wraper-tumbler-gunther">
                    <img src="<?php bloginfo('url'); ?>/wp-content/uploads/2025/05/fondo-tumbler.jpg" alt="Günther Tumbler">
                </div>

                <a href="https://taglermaq.cl/procesamiento/?_filter_procesamiento=masajeadoras">
                    <div class="wrapper-txt-tumbler">
                        <img class="img1" src="<?php bloginfo('url'); ?>/wp-content/uploads/2025/05/txt-tumbler-industriales.png" alt="txt1">  
                        <img class="img2" src="<?php bloginfo('url'); ?>/wp-content/uploads/2025/05/txt-detalle-tumbler.png" alt="txt2">                 
                    </div>
                </a>

                <div class="wrapper-block-gunther">
                    <img src="<?php bloginfo('url'); ?>/wp-content/uploads/2025/05/block-gunther.png" alt="Gunther">
                </div>
            </div>
...
<div class="wrapper--maquinasv2">
    ...
    <span class="title--verde">DESTACADAS</span></h2>
